...
/***/ (function(module, exports, __webpack_require__) {
	...
	function createPOI(lat, lng, plots) {
		return {
			lat: lat,
			lng: lng,
			plots: plots || ["L50 12.5-125Hz", "L50 160-1250Hz", "L50 1600-12500Hz"]
		};
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function drawUpDownPolarWithCheckboxesAndThresholds(data, div, poi) {
	  ...
	  var angleAccessor = function angleAccessor(d, i) {
	    var f = d[0];
	    var match = f.match(/Hr(\d\d)/);
	  ...
	  */
	  ...
	  var ga_a = svg.append("g").attr("class", "a axis").selectAll("g").data(d3.range(0, 24, 2)).enter().append("g").attr("transform", function (d) {
	    return "rotate(" + (d * 15 - 90) + ")";
	  });
	  ...
	  */
	  ...
	  var sortFunc = function sortFunc(a, b) {
	    var aHour = Number(a[0].match(/Hr(\d\d)/)[1]);
	    var bHour = Number(b[0].match(/Hr(\d\d)/)[1]);
	    return aHour - bHour;
	  };
	...
	function pullDistinctColor(plotName) {
	  // hackey af - MG
	  var groups = ["12-125", "12.5-125", "160-1250", "1600-12500"];
	  var colors = ["red", "red", "green", "blue"];
	  var g = groups.filter(function (g) {
	    return plotName.indexOf(g) > -1;
	  }).pop();
